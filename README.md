...
OPENCLOSE.Size = UDim2.new(0, 46,  0, 36)
OPENCLOSE.Font = Enum.Font.DenkOne
OPENCLOSE.Text = "MILA X HUB"
OPENCLOSE.TextColor3 = Color3.fromRGB(93, 21, 238)
...
local Library = Update:Window("MILA x hub ","",Enum.KeyCode.RightControl);
local AutoFarm = Library:Tab("เธญเธญเนเธ•เนเธเธฒเธฃเนเธก")
local Auto = Library:Tab("เธ—เธณเธเธญเธเธญเธญเนเธ•เน")
local Stats = Library:Tab("เธชเธ–เธฒเธเธฐ")
local tp = Library:Tab("Teleport")
local Dungeon = Library:Tab("เธฅเธเธ”เธฑเธ + Esp")
local DevilFruit = Library:Tab("เธเธฅเนเธกเนเธเธตเธจเธฒเธ")
local Shop = Library:Tab("เธฃเนเธฒเธเธเนเธฒ")
local Misc = Library:Tab("เธญเธทเนเธ เน")
local Setting = Library:Tab("เธเธฒเธฃเธ•เธฑเนเธเธเนเธฒ")
